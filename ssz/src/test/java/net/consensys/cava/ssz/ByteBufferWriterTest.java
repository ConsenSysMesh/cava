...
class ByteBufferWriterTest {
  ...
  void shouldWriteShortLists() {
    ...
    assertEquals(
        fromHexString(
            "0000000b00000004617364660000000471776572000000047A78637600000004617364660000000471776572000000047A78637600000004617364660000000471776572000000047A78637600000004617364660000000471776572"),
        Bytes.wrapByteBuffer(buffer));
  }
