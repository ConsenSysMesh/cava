...
[![Download](https://api.bintray.com/packages/consensys/consensys/cava/images/download.svg?version=0.3.1) ](https://bintray.com/consensys/consensys/cava/0.3.1)
...
With Gradle: `compile 'net.consensys.cava:cava:0.3.1'`
...
- [Online Kotlin documentation](https://consensys.github.io/cava/docs/kotlin/0.3.1/cava)
- [Online Java documentation](https://consensys.github.io/cava/docs/java/0.3.1)
